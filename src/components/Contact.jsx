        ...
        <div className="contact__inner">
          ...
          <div className="contact__info">
            ...
            <div className="contact__socials">
              <a href="https://github.com/cr7st74n" target="_blank" rel="noreferrer" className="contact__social" aria-label="GitHub">
              ...
              <a href="https://www.linkedin.com/in/cristian-gonzalez-7566571b0/" target="_blank" rel="noreferrer" className="contact__social" aria-label="LinkedIn">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
